...
public class PickUpAndDeliver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pick_up_and_deliver);
        _init();
    ...
    private void addSelectedItems() {
        ...
        if(laundryWeight.equals("0 kg") || bedSheetWeight.equals("0 kg") || blanketWeight.equals("0 kg")) {
            ...
            selectedItemsMap.put("ServicesType", "Pick Up and Deliver");
    ...
    private void addKgDialog(final TextView tv, final double pricePerKg) {
        View addKgDialog = LayoutInflater.from(this).inflate(R.layout.add_kg_dialog, null);
        AlertDialog.Builder addKgDialogBuilder = new AlertDialog.Builder(this);
